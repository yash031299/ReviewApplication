...
public final class Review {
    ...
    public static final class Builder {
        ...
        private void assertNotBuilt() {
            if (built) {
                throw new IllegalStateException("Builder instance has already built a Review.");
            }
        }
         ...
         * @throws IllegalStateException if the builder is reused or any required field is missing/invalid
         */
        public Review build() {
            assertNotBuilt();
        ...
        private void validateRequiredFields() {
            if (reviewId == null) {
                throw new IllegalStateException("Review ID must not be null.");
            }
            if (reviewedDate == null) {
                throw new IllegalStateException("Reviewed date must not be null.");
            }
            if (productRating == null) {
                throw new IllegalStateException("Product rating must not be null.");
            }
        }

        private void validateRatingRange() {
            if (productRating < 1 || productRating > 5) {
                throw new IllegalStateException("Product rating must be between 1 and 5.");
            }
        }
    }
}
