...
public final class Statistics {
    ...
    public static final class Builder {
         ...
         * @return this builder
         * @throws com.reviewapp.application.exception.InvalidInputException if {@code totalReviews} is negative
         */
        public Builder setTotalReviews(int totalReviews) {
            assertNotBuilt();
            if (totalReviews < 0) {
                throw new com.reviewapp.application.exception.InvalidInputException("Total reviews cannot be negative.");
            }
         ...
         * @return this builder
         * @throws com.reviewapp.application.exception.InvalidInputException if {@code averageRating} is negative
         */
        public Builder setAverageRating(double averageRating) {
            assertNotBuilt();
            if (averageRating < 0) {
                throw new com.reviewapp.application.exception.InvalidInputException("Average rating cannot be negative.");
            }
         ...
         * <ul>
         *   <li>{@code totalReviews ≥ 0}</li>
         *   <li>{@code averageRating ≥ 0}</li>
         * </ul>
         *
         * @return a validated immutable {@link Statistics} instance
         * @throws IllegalStateException if the builder is reused
         * @throws com.reviewapp.application.exception.InvalidInputException if validation fails
         */
