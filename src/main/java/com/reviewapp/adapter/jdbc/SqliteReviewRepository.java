...
public class SqliteReviewRepository implements ReviewQueryPort, ReviewWritePort, ReviewStatsPort {
    ...
    /*
     * Returns all reviews (delegates to {@link #getAllReviews()}).
     * @Deprecated: Used only for testing in command_line_interface
     */
    ...
    public List<Review> getAllReviews() {
        ...
        try (Connection connection = DriverManager.getConnection(jdbcUrl);
            ...
            throw new RuntimeException("SQL error fetching all reviews", e);
        }
        return result;
    }
