...
class AlertDialogsTest {
    /**
     * Tests that showing info dialog with null parent does not throw.
     */
    @Test
    ...
    /**
     * Tests that showing warning dialog with null parent does not throw.
     */
    @Test
    ...
    /**
     * Tests that showing error dialog with null parent does not throw.
     */
    @Test
    ...
    /**
     * Tests that showing confirm dialog with null parent returns a valid option.
     */
    @Test
    ...
    /**
     * Tests that showing dialogs with empty title and message does not throw.
     */
    @Test
